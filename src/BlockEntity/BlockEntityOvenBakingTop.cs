...
{
    public class BlockEntityOvenBakingTop : BlockEntityDisplay, IHeatSource, ITexPositionSource
    {
        ...
        public BlockEntityOvenBakingTop()
        {
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            RegisterGameTickListener(OnBurnTick, 5000);
        ...
        public virtual bool OnInteract(IPlayer byPlayer, BlockSelection bs)
        {
            ...
            else
            {
                ...
                if (colObj.Attributes?["bakingProperties"] != null || colObj.CombustibleProps?.SmeltingType == EnumSmeltType.Bake && colObj.CombustibleProps.MeltingPoint < maxBakingTemperatureAccepted)  //Can't meaningfully bake anything requiring heat over 260 in the basic clay oven
                {
